...
#echo ./MB_jet_skim.exe $MBFILE "MB_$OUTFILE"
#./MB_jet_skim.exe $MBFILE "MB_${OUTFILE}"
...
if [[ $? -eq 0 ]]; then
    ...
    gfal-copy file://$PWD/MB_${OUTFILE} gsiftp://se01.cmsaf.mit.edu:2811/${SRM_PATH}/MB_${OUTFILE}
    #gfal-copy file://$PWD/$MERGEOUT gsiftp://se01.cmsaf.mit.edu:2811/${SRM_PATH}/$MERGEOUT
