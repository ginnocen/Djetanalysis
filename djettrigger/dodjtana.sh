...
# nJET loop
JETPTMIN=(40 40 40 40)
JETETAMIN=(0.3 0.3 0.3 0.3)
JETETAMAX=(1.6 1.6 1.6 1.6)
HLTOPT=("noHLT" "HLTJet40" "HLTJet40Jet60" "HLTJet60")
...
g++ $PREFIXCODE/djtana_savetpl.C $(root-config --cflags --libs) -g -o djtana_savetpl.exe || return 1;
g++ $PREFIXCODE/djtana_savehist.C $(root-config --cflags --libs) -g -o djtana_savehist.exe || return 1;
...
# djtana_usehist.C #
g++ $PREFIXCODE/djtana_usehist.C $(root-config --cflags --libs) -g -o djtana_usehist.exe || return 1;
...
# djtana_plothist.C #
g++ $PREFIXCODE/djtana_plothist.C $(root-config --cflags --libs) -g -o djtana_plothist.exe || return 1;
