...
void weightDpt_plothist(TString inputname, TString collisionsyst)
{
  xjjroot::setgstyle();
...
int main(int argc, char* argv[])
{
  if(argc==3)
    {
      weightDpt_plothist(argv[1], argv[2]);
      return 0;
    }
  std::cout<<"  Error: invalid arguments number - weightDpt_plothist()"<<std::endl;
  return 1;
}
