...
class DJetTree {
  ...
  int hiBin_mix[nEventsToMix];
  float vz_mix[nEventsToMix];
  float hiEvtPlanes_mix[nEventsToMix];
...
void DJetTree::create_tree(TTree* t) {
    ...
    t->Branch("hiBin_mix", hiBin_mix, "hiBin_mix[nmix]/I");
    t->Branch("vz_mix", vz_mix, "vz_mix[nmix]/F");
    t->Branch("hiEvtPlanes_mix", hiEvtPlanes_mix, "hiEvtPlanes_mix[nmix]/F");
