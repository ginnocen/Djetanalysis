...
{
	std::string filename = "~/djetmix231.root";
	Float_t jetptmin = 20;
	xjjroot::setgstyle();
	...
	TH2F* ptempty = new TH2F("pt",";p_{t};#frac{1}{N} #frac{dN}{dp_{t}}",100,0,100,100,0,.1);
	...
	t->Draw("jetpt_akpu3pf>>djpt","jetpt_akpu3pf>20","0");
	t->Draw("jeteta_akpu3pf>>djeta","jetpt_akpu3pf>20","0");
	t->Draw("jetphi_akpu3pf>>djphi","jetpt_akpu3pf>20","0");
	t->Draw("MBjetpt_akpu3pf>>MBpt","jetpt_akpu3pf>20","0");
	t->Draw("MBjeteta_akpu3pf>>MBeta","jetpt_akpu3pf>20","0");
	t->Draw("MBjetphi_akpu3pf>>MBphi","jetpt_akpu3pf>20","0");
	djpt->Sumw2();
	MBpt->Sumw2();
	djeta->Sumw2();
	MBeta->Sumw2();
