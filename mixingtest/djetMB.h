...
public:
  ...
  int*                   anjet[ncases]     =   {&njet_akpu3pf,        &njet_akpu3pf,        &ngen_akpu3pf,      &ngen_akpu3pf};
  int*                   MBanjet[ncases]   =   {&MBnjet_akpu3pf,      &MBnjet_akpu3pf,      &ngen_akpu3pf,      &ngen_akpu3pf};
  std::vector<float>**   ajetpt[ncases]    =   {&jetpt_akpu3pf,       &jetpt_akpu3pf,       &genpt_akpu3pf,    &genpt_akpu3pf};
  std::vector<float>**   MBajetpt[ncases]  =   {&MBjetpt_akpu3pf,     &MBjetpt_akpu3pf,     &genpt_akpu3pf,    &genpt_akpu3pf};
  std::vector<float>**   ajeteta[ncases]   =   {&jeteta_akpu3pf,      &jeteta_akpu3pf,      &geneta_akpu3pf,   &geneta_akpu3pf};
  std::vector<float>**   MBajeteta[ncases] =   {&MBjeteta_akpu3pf,    &MBjeteta_akpu3pf,    &geneta_akpu3pf,   &geneta_akpu3pf};
  std::vector<float>**   ajetphi[ncases]   =   {&jetphi_akpu3pf,      &jetphi_akpu3pf,      &genphi_akpu3pf,   &genphi_akpu3pf};
  std::vector<float>**   MBajetphi[ncases] =   {&MBjetphi_akpu3pf,    &MBjetphi_akpu3pf,    &genphi_akpu3pf,   &genphi_akpu3pf};
