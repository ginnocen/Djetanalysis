...
void JetShape(){
   ...
   inputPP=Form("resultsPP_jet%d_Dlow%d_Dhigh%d.root",intjetpt_cut,intDptlow_cut,intDpthigh_cut);
   inputPbPb=Form("resultsPbPb_jet%d_Dlow%d_Dhigh%d.root",intjetpt_cut,intDptlow_cut,intDpthigh_cut);
  ...
  TH2F* hempty=new TH2F("hempty","",50,0,0.5,10,0.,5.0);
