...
int main(int argc, char* argv[])
{
  if(argc==10)
    {
      jetstudies_savehisto(argv[1], argv[2], argv[3], atoi(argv[4]), atoi(argv[5]), atof(argv[6]), atof(argv[7]), atof(argv[8]), atoi(argv[9]));
      return 0;
    }
  if(argc==9)
    {
      jetstudies_savehisto(argv[1], argv[2], argv[3], atoi(argv[4]), atoi(argv[5]), atof(argv[6]), atof(argv[7]), atof(argv[8]));
      return 0;
    }
  else if(argc==1)
    {
