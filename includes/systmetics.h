...
namespace djtsyst
{
  ...
  std::vector<std::vector<Float_t>> syst60999_NONCLOSURE_ratio = {{5.8, 3.8, 5.4, 7.7},
                                                                  {1.7, 4.3, 1.8, 1.2}};
  ...
  std::vector<std::vector<Float_t>> syst60999_TRIGGER_pp = {{1.1, 1.8, 1.8, 1.6},
                                                            {0.3, 0.6, 2.8, 1.3}};
  std::vector<std::vector<Float_t>> syst60999_TRIGGER_PbPb = {{6.9, 6.6, 0.7, 17.0},
                                                              {0.8, 1.7, 5.1, 9.2}};
  std::vector<std::vector<Float_t>> syst6080_TRIGGER_pp = {{0.2, 0.7, 0.7, 0.2}};
  std::vector<std::vector<Float_t>> syst80100_TRIGGER_pp = {{0.2, 0.7, 0.7, 0.2}};
  std::vector<std::vector<Float_t>> syst100999_TRIGGER_pp = {{0.2, 0.7, 0.7, 0.2}};
  std::vector<std::vector<Float_t>> syst6080_TRIGGER_PbPb = {{0.6, 2.9, 6.2, 6.2}};
  std::vector<std::vector<Float_t>> syst80100_TRIGGER_PbPb = {{0.6, 2.9, 6.2, 6.2}};
  std::vector<std::vector<Float_t>> syst100999_TRIGGER_PbPb = {{0.6, 2.9, 6.2, 6.2}};
