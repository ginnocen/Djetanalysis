...
namespace djtsyst
{
  ...
  // pdf variation
  std::vector<std::vector<Float_t>> syst60999_PDF_pp = {{4.6, 4.8, 3.1, 2.6},
                                                        {3.8, 3.7, 4.5, 6.2}};
  std::vector<std::vector<Float_t>> syst60999_PDF_PbPb = {{5.4, 6.3, 4.9, 4.1},
                                                          {6.0, 5.1, 9.1, 18.6}};
  std::vector<std::vector<Float_t>> syst6080_PDF_pp = {{3.8, 3.7, 3.2, 2.8}};
  std::vector<std::vector<Float_t>> syst80100_PDF_pp = {{3.9, 3.1, 3.3, 4.6}};
  std::vector<std::vector<Float_t>> syst100999_PDF_pp = {{4.3, 4.3, 3.4, 3.1}};
  std::vector<std::vector<Float_t>> syst6080_PDF_PbPb = {{6.1, 4.9, 6.1, 8.2}};
  std::vector<std::vector<Float_t>> syst80100_PDF_PbPb = {{4.8, 5.1, 6.8, 6.0}};
  std::vector<std::vector<Float_t>> syst100999_PDF_PbPb = {{6.4, 6.8, 7.0, 9.7}};

  std::vector<std::vector<Float_t>> syst60999_PDF_ratio = {{3.5, 3.9, 1.9, 2.1},
                                                           {2.7, 3.1, 10.1, 23.3}};
  std::vector<std::vector<Float_t>> syst6080_PDF_ratio = {{2.4, 1.4, 4.3, 5.5}};
  std::vector<std::vector<Float_t>> syst80100_PDF_ratio = {{1.3, 2.6, 3.9, 8.5}};
  std::vector<std::vector<Float_t>> syst100999_PDF_ratio = {{3.4, 4.0, 4.0, 7.3}};
