                      ...
                      Float_t jetptmin, Float_t jetptmax, Float_t jetetamin, Float_t jetetamax)
{
  ...
  for(int i=0;i<nPtBins;i++)
    {
      // if(ahSignalRsubP[1][i]->GetBinContent(nDrBins) < 0) ahSignalRsubP[1][i]->SetBinContent(nDrBins, 1.e-10);
      ahSignalRsubP[1][i]->SetBinContent(nDrBins, 1.e-10);
      ahSignalRsubRatio[i]->SetBinContent(nDrBins, -10);
